 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   | MO(1)|Delete| LALT |   [  |   ]  |                                       | LEFT | DOWN |  UP  | RIGHT| MO(1)  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,---------------.
 *                                        | VOLD | VOLU |       | PGDN |  PGUP  |
 *                                 ,------|------|------|       |------+--------+------.
...
[BASE] = LAYOUT_ergodox(
    ...
    MO(1),   KC_DEL,  KC_LALT, KC_LBRC, KC_RBRC,
                                                          KC_VOLD, KC_VOLU,
                                                                   KC_MUTE,
                                                 KC_SPC,  KC_BSPC, MO(1),
             ...
             KC_RGUI, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                               KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, MO(1),
    KC_PGDN, KC_PGUP,
    KC_HOME,
    MO(1),   KC_ENT,  KC_SPC),
...
[FIRST] = LAYOUT_ergodox(
    ...
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
             ...
             KC_TRNS, KC_TRNS, KC_TRNS, KC_INS,  KC_TRNS, KC_PSCR, KC_TRNS,
